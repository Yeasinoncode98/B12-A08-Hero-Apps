...
// //           data.title.toLowerCase().includes(searchTrim)
// //         );
...
// //       <div className="flex justify-between items-center mt-6 max-sm:p-3">
...
// //             <HomeProduct data={data} key={data.id}></HomeProduct>
// //           ))}
// //         </div>
// //       ) : (
// //         <AppNotFound />
...
//     const timer = setTimeout(() => {
//       const searchTrim = searchValue.trim().toLowerCase().replace(/\s+/g, " ");
//       if (searchTrim) {
//         const searchResult = app.filter((data) =>
//           data.title.toLowerCase().replace(/\s+/g, " ").includes(searchTrim)
//         );
//         setFilteredApps(searchResult);
//       } else {
//         setFilteredApps(app || []);
